...
public:
    ...
    */
    ...
    //a vector to store the types of food the Zoo has
    std::vector<Food> food_type;  
    ...
    */
    ...
    // a vector to store all animals currently held by the zoo
    std::vector<Animal*> pointer; 
    /*
